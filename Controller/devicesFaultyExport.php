...
echo 'IMEI' . "\t" . 'Pole Id' . "\t" . 'Project Name' . "\t" . 'District' . "\t" . 'Block' . "\t" . 'Panchayat' . "\t" . 'Ward' . "\t" . 'Luminary QR' . "\t" . 'Battery QR' . "\t" . 'Panel QR' . "\t" . 'Latitude' . "\t" . 'Longitude' . "\t" . 'GoogleMap' . "\t" . 'Remark' . "\t" . 'Installed By' . "\t" . 'Date' . "\t" . 'Time' . "\t" . 'Approved Status' . "\n";
...
foreach ($devData as $dRow) {
	...
	if (trim($projeName) != "") {
		$csvData = $dRow['device'] . "\t" . $dRow['name'] . "\t" . $projeName . "\t" . $distName . "\t" . $blockName . "\t" . $panchName . "\t" . $wardName . "\t" . $dRow['luminary_qr'] . "\t" . $upperBattery . "\t" . $dRow['panel_qr'] . "\t" . $dRow['lat'] . "\t" . $dRow['lng'] . "\t" . $googleLink . "\t" . $ucRemark . "\t" . $urInstaller . "\t" . $dateTimeArr[0] . "\t" . $dateTimeArr[1] . "\t" . $approvedStatus . "\n" . $csvData;
	}
}
