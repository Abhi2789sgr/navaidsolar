...
<div class="w3-bg-image">
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter">
			<div class="w3-container w3-padding-16 m8-fancy w3-black">
				<div class="w3-left"><i class="w3-icon-color w3-icon fa fa-lightbulb-o" style="font-size:30px"></i>
					...
					<i class="w3-icon-color w3-icon fa fa-lightbulb-o" style="font-size:60px"></i>
				</div>
				<div class=" w3-right">
					<h3>
						<?php
		...
		<div class="w3-quarter w3-button" onclick="window.location.assign('?item=7')">
			<div class="w3-container w3-padding-16 w3-hover-amber m8-fancy w3-black">
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter w3-button0" onclick0="window.location.assign('?item=2')">
			<div class="w3-container w3-padding-16 w3-hover-red0 m8-fancy w3-black">
