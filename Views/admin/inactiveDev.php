		...
		<tbody>
			...
			?>
					<tr>
						...
						<td>
							<button class="w3-button w3-green m8-fancy" style="width:100px;" onclick="authoriseInactiveDevice('<?php echo $row['dev_id']; ?>')">Accept</button><br><br>
...
<div id="idDeleteDevice" class="w3-modal">
	<div class="w3-modal-content w3-animate-top w3-card-4" style="width:400px;height:auto;height:200px;">
		...
		<div class="w3-padding" id="deleteDeviceButton"></div>
	</div>
</div>

<script>
	function authoriseInactiveDevice(imei) {
		console.log(imei);
		var param = "imei=" + imei;
