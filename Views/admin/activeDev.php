	...
	<table id="id01" class="w3-table-all">
		...
		<tr w3-repeat="result">
			...
			<td>
				...
				<button type="button" class="w3-button m8-fancy" style="width:100px; background-color:aqua" data-toggle="modal" data-target="#myModal" id="{{Dev_id}}" onclick="setImei(event)">Edit</button>
			</td>
		</tr>
	</table>
</div>
