...
<div class="w3-bg-image">
	...
	<div class="w3-row-padding w3-margin-bottom">
		...
		<div class="w3-quarter">
			<div class="w3-container w3-orange w3-text-white w3-padding-16 m8-fancy w3-black">
	...
	<div class="w3-row-padding w3-margin-bottom">
		<div class="w3-quarter" onclick0="window.location.assign('?item=2')">
		...
		<div class="w3-quarter">
			<div class="w3-container w3-deep-orange w3-text-white w3-padding-16 m8-fancy w3-black">
