...
.w3-color, .w3-hover-color:hover{color: #fff!important;background-color: #08689b!important;}
.w3-text-color, .w3-hover-text-color:hover {color: #08689b!important;}
...
<div class="w3-bar w3-top w3-large w3-card-4" style="z-index:4;background-color:#fff;color:#fff;">
  ...
  <span class="w3-bar-item w3-hide-small" style="background-color:#08689b;height:61px;padding-top:15px;"><b><?php echo $project_name; ?></b></span>
  <span class="w3-bar-item w3-hide-medium w3-hide-large" style="background-color:#08689b;height:61px;padding-top:15px;"><b>NavAid RMS</b></span>
  ...
  <span class="w3-hide-small w3-right w3-large w3-margin-left w3-margin-right" style="margin-top:17px;color:#08689b;"><span>Welcome, <strong><?php echo $name; ?></strong></span></span>
